...
/**
 * Provides the local service interface for NotFound. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Thiago Moreira
 * @see NotFoundLocalServiceUtil
...
public interface NotFoundLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link NotFoundLocalServiceUtil} to access the not found local service. Add custom service methods to {@link br.com.thiagomoreira.liferay.plugins.notfound.services.service.impl.NotFoundLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
